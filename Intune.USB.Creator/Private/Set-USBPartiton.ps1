function Set-USBPartition {
    ...
    try {
        ...
        $usbClass.drive = (New-Partition -DiskNumber $diskNum -Size 1GB -AssignDriveLetter | Format-Volume -FileSystem FAT32 -NewFileSystemLabel WINPE -Confirm:$false -Force).DriveLetter
